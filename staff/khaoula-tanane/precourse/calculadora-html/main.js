...
var signs = ['*', '/', '+', '-']
var startWithoutSigns = ['*', '/', '+']
function addValue(value){
    if(!screenElement.innerText && startWithoutSigns.includes(value)) return
    if(screenElement.innerText && signs.includes(value) && signs.includes(screenElement.innerText[screenElement.innerText.length-1])) return
    console.log(screenElement.innerText[0])
